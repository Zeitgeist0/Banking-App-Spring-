delete from employers_customers;
delete from accounts;
delete from customers;
delete from employers;
delete from sys_users;
delete from sys_roles;
delete from sys_users_sys_roles;
...
INSERT INTO accounts (number, currency, balance, customer_id) VALUES
                                                                  ('678ce8f1-7fbc-495f-afb4-d1f469afdcd4', 0, 10000000.0, 1),
                                                                  ('593c74fe-ba9e-441f-8567-1a551e0962fc', 3, 200000,  2),
...
INSERT INTO sys_users ( id, enabled, name, password) values
                                                         (1, true, 'user', '$2a$10$K9JPQN3KUq5KpYJ0T3q6.eJmbEd0/TJ9ONklmMbiLNyUmZAteKf9q'),
                                                         (2, true, 'admin', '$2a$10$zNnqwsJMAnAE0LuR4STkGeXH6prYIFKh8bOFCsteFbaX7.E1jMlwq');
INSERT INTO sys_roles ( id,  name) values
                                       (1, 'USER'),
                                       (2 , 'ADMIN');

insert into sys_users_sys_roles(sys_users_id, sys_roles_id) VALUES
                                                                (1,1),
                                                                (2,2),
                                                                (2,1);