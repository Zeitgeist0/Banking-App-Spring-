...
public class AccountControllerIntegrationTest {
  ...
  public void test_GetAll() throws Exception {
    ...
    this.mockMvc.perform(MockMvcRequestBuilders.get("/accounts/all").contentType("application/json"))
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$[0].balance", Matchers.is(10000000.0)))
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$[1].balance", Matchers.is(200000.0)))
  ...
  public void test_GetById() throws Exception {
    ...
    this.mockMvc.perform(MockMvcRequestBuilders.get("/accounts/getById")
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("balance", Matchers.is(10000000.0)))
